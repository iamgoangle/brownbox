...
import { selectSize } from './../actions/ItemDetailAction';

injectTapEventPlugin();

@connect((store) => {
    return {
        value : store.ItemDetailReducer.value,
    }
})
export default class ItemDetailContainer extends React.Component {
    ...
    constructor(props, context) {
        super(props, context);
        this.state = context.data[ItemDetailContainer.NAME] || {};
    ...
    handleChange(event, index, value){
        console.log(value);
        this.props.dispatch(selectSize(value));
    }
                ...
                <div className="row">
                    ...
                    <div className="col-md-4">
                        <div>
                            ...
                            <h3>Stickers</h3>
                            <Divider/>
                            Size : <SelectField value={this.props.value} onChange={this.handleChange} id="item-size-select">
